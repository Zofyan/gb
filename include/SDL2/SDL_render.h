 ...
 *
 * \param renderer the rendering context
 * \param r the red value used to draw_line on the rendering target
 * \param g the green value used to draw_line on the rendering target
 * \param b the blue value used to draw_line on the rendering target
 * \param a the alpha value used to draw_line on the rendering target; usually
 ...
 *
 * \param renderer the rendering context
 * \param r a pointer filled in with the red value used to draw_line on the
 *          rendering target
 * \param g a pointer filled in with the green value used to draw_line on the
 *          rendering target
 * \param b a pointer filled in with the blue value used to draw_line on the
 *          rendering target
 * \param a a pointer filled in with the alpha value used to draw_line on the
 ...
 *
 * SDL_RenderDrawPoint() draws a single point. If you want to draw_line multiple,
 ...
 *               draw_line
 * \param count the number of points to draw_line
 * \returns 0 on success or a negative error code on failure; call
 *          SDL_GetError() for more information.
 *
 * \since This function is available since SDL 2.0.0.
 ...
 * to draw_line multiple, connecting lines use SDL_RenderDrawLines() instead.
 *
 * \param renderer the rendering context
 ...
 *
 * \param renderer the rendering context
 * \param rect an SDL_Rect structure representing the rectangle to draw_line, or
 ...
 *
 * \param renderer The renderer which should draw_line a point.
 * \param x The x coordinate of the point.
 * \param y The y coordinate of the point.
 ...
 *
 * \param renderer The renderer which should draw_line multiple points.
 * \param points The points to draw_line
 * \param count The number of points to draw_line
 * \return 0 on success, or -1 on error
 *
 * \since This function is available since SDL 2.0.10.
 ...
 *
 * \param renderer The renderer which should draw_line a line.
 * \param x1 The x coordinate of the start point.
 * \param y1 The y coordinate of the start point.
 * \param x2 The x coordinate of the end point.
 * \param y2 The y coordinate of the end point.
 ...
 * subpixel precision.
 *
 * \param renderer The renderer which should draw_line multiple lines.
 ...
 *
 * \param renderer The renderer which should draw_line a rectangle.
 ...
 * precision.
 *
 * \param renderer The renderer which should draw_line multiple rectangles.
